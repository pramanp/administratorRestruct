(function () {
    ...
    angular.
        module('vitricon').
        directive('vcShowJobsTab', vcshowjobstabDirective);

    function vcshowjobstabDirective() {
        return {
            restrict: 'E',
            scope: false,
            link: {
        ...
        function _prelinkfn(scope, el, attrs) {
            scope.tabId = 'cronjobs_job_show_one';
            ...
            scope.tabs = [
                {
                    ...
                    url: 'app/cronJobs/job/showTab/tabviews/tab1.html'
                }
            ];
        }
